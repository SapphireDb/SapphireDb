...
namespace SapphireDb.Command.Renew
{
    class RenewCommandHandler : AuthCommandHandlerBase, ICommandHandler<RenewCommand>
    {
        ...
        private async Task<ResponseBase> RenewToken(RenewCommand command, ISapphireAuthContext context)
        {
        ...
        private RefreshToken GetRefreshToken(ISapphireAuthContext context, RenewCommand command)
        {
