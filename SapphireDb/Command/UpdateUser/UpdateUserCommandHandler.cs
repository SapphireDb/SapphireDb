...
namespace SapphireDb.Command.UpdateUser
{
    class UpdateUserCommandHandler : AuthCommandHandlerBase, ICommandHandler<UpdateUserCommand>
    {
        ...
        public UpdateUserCommandHandler(AuthDbContextAccesor authDbContextAccessor, ConnectionManager connectionManager,
        ...
        {
            ISapphireAuthContext context = GetContext();
        ...
        private async Task<ResponseBase> HandleUserUpdate(dynamic user, UpdateUserCommand command, dynamic usermanager, ISapphireAuthContext context)
        {
